 ...
 *
 * Applied per source by components/app-image.tsx, never as `loader` in next.config: a loader
 * configured there is global AND disables /_next/image, which the assets in /public need.
