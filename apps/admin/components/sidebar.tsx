...
import { ChevronLeft, ChevronRight, Contact, Home, Package, ShoppingCart, Truck, Users } from "lucide-react"
...
export function Sidebar({ className, stats, userInfo }: SidebarProps) {
    ...
    const DASHBOARDS = [
        ...
        },
        {
            ...
            badge: stats.contacts > 0 ? stats.contacts : undefined,
            url: "/admin/contact",
        }
    ]
                ...
                <motion.div variants={contentVariants} className="flex h-full flex-col w-[280px]">
                    <div className="flex items-center justify-between p-6 border-b border-border/30">
                        <div className="flex items-center gap-3">
                            <div className="w-9 h-9 bg-linear-to-br from-primary to-primary/80 rounded-xl flex items-center justify-center shadow-lg shadow-primary/20">
