...
const LANGUAGES: Language[] = [
    ...
    { code: "ar", name: "العربية", nativeName: "Arabic", region: "Middle East", dir: "rtl" },
]
                ...
                <div className="h-full flex flex-col">
                    ...
                    <div className="px-8 py-6 border-t border-border">
                        <p className="text-sm text-muted-foreground font-light">
                            {isPending ? 'Switching language...' : 'The New Thesaurus: A Guide to Residential Lighting Solutions'}
                        </p>
                    </div>
                </div>
            </SheetContent>
