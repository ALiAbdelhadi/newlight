...
export function Hero() {
    ...
    return (
        <div className="h-[60%] bg-background text-foreground pb-72 md:pb-0">
                ...
                <div className="lg:col-span-5 grid grid-rows-2 gap-0">
                    ...
                    >
                        <div className="text-center">
                            <h2 className="text-5xl lg:text-6xl font-light mb-2 text-card-foreground">Inspiration</h2>
                        </div>
                    </div>
                    <div className="grid grid-cols-2 gap-0">
                        ...
                        >
                            ...
                            <div className="relative z-20 h-full flex items-end p-8">
                                <Link
                                    href="category"
                                    className="text-4xl lg:text-5xl font-light text-primary-foreground transition-all duration-300 hover:tracking-wider"
                                >
                                    Products
                                </Link>
                            </div>
